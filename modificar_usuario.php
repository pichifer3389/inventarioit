...
$error=false;
 if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['btn-actualizar'])) {
    ...
    $agencia=$_POST['agencia']; 
            ...
            $sql="UPDATE inventario.equipo SET descripcion='$descripcion',marca='$marca',modelo='$modelo',numero_inventario='$numero_inventario',nombre='$asignado',ip='$ip',agencia='$agencia' where id_equipo='$id_equipo_a'";
                if (mysqli_query($conn, $sql)) {
                
                //$error=true;
                //$confirmar_ingreso="El registro se guardo correctamente";
               // header('location:administracion.php');
                    echo "<script languaje='javascript'>alert('Usuario actualizado correctamente');"
        ...
        <div class="col-md-12">
          ...
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Modificación de usuarios</h3>
            </div>
          ...
          <div class="adv-table editable-table ">
                          ...
                          <div class="clearfix">
                              <form role="form" method="post" class="row"> 
                                              ...
                                              <?php 
                                $id_usuario_m = $_GET['id'];

 

                                        $sql = "SELECT * FROM inventario.usuarios where id_usuarios='$id_usuario_m'";
                             ...
                             while($row = $query->fetch_assoc()){?>
                                                    ...
                                                    <?php $id_usuario_m= $row['id_usuarios'];?>
                                                    <?php $usuario_m= $row['usuario']; ?>
                                                    <?php $nombre_mm= $row['nombre']; ?>
                                                    <?php $rol= $row['modelo']; ?>
