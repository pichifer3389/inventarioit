...
$error=false;
 ...
 if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['btn-actualizar'])) {
    $secuencial_puesto=$_POST['id'];
     $nombre_puesto=strtoupper($_POST['nombre_puesto']);
    
    
    
            $sql="UPDATE inventario_it.puesto SET NOMBRE='$nombre_puesto' where SECUENCIAL='$secuencial_puesto'";
                if (mysqli_query($conn, $sql)) {
                
                //$error=true;
                //$confirmar_ingreso="El registro se guardo correctamente";
                //header('location:administracion.php');
                    echo "<script languaje='javascript'>alert('El puesto $nombre_puesto se actualizó correctamente');"
        ...
        <div class="col-md-12">
          ...
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Modificación Puestos</h3>
            </div>
                          ...
                          <div class="clearfix">
                              <form role="form" method="post" class="row"> 
                                ...
                                $secuencial_puesto = $_GET['id'];
                                        ...
                                        $sql = "SELECT * FROM inventario_it.puesto where SECUENCIAL='$secuencial_puesto'";
                                        $query = $conn->query($sql);

                                            $row = $query->fetch_assoc();
                                            $secuencial_agencia2=$row['SECUENCIAL'];
                                             $nombre_puesto= $row['NOMBRE']; ?>
                                                 ...
                                                 <div class="form-group col-md-6" style="margin-bottom: 35px"  >
                                                    ...
                                                    <input type="text" name="nombre_puesto"  class="form-control" value="<?= $nombre_puesto?>" style="text-transform:uppercase;" required>
                                      ...
                                      <a id="btn-cancelar" class="btn btn-danger btn-lg " href="puestos.php" name="btn-cancelar">Cancelar <i class="fa fa-times"></i></a>		
