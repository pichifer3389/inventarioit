...
$error=false;
 ...
 if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['btn-guardar'])) {
    $nombre_agencia=strtoupper($_POST['nombre_agencia']);
     
    
    
       
    
    $res=mysqli_query($conn,"SELECT * FROM agencias WHERE nombre='$nombre_agencia' ");
	   $row=mysqli_fetch_array($res);
	   $count = mysqli_num_rows($res); 
   
		if( $count != 0) {
			$error = true;
			$error_inventario = "La agencia $nombre_agencia ya se encuentra registrada";
                        
                  
		} else{
                    
                     
            $sql="INSERT INTO inventario_it.agencias (nombre,SECUENCIALESTADO) VALUES ('$nombre_agencia', '4')";
            
                    
                if (mysqli_query($conn, $sql)) {
                
                //header('location:administracion.php');
                echo "<script languaje='javascript'>alert('La agencia $nombre_agencia se registro correctamente');"
        ...
        <ul>
          ...
          <li> <a href="javascript:void(0);"> <i class="fa fa-users icon"></i>Usuarios<span class="plus"><i class="fa fa-plus"></i></span> </a>
            ...
            <ul class="opened" style="display:block">
                <li> <a href="agencias.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">Agencias</b> </a> </li>
              <li> <a href="departamentos.php"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Departamentos</b> </a> </li>
              <li> <a href="puestos.php"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Puestos</b> </a> </li>
        ...
        <div class="col-md-12">
          ...
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Agencias</h3>
            </div>
         <div class="porlets-content">
          ...
          <div class="adv-table table-responsive ">
                          ...
                          <div class="clearfix">
                              <div class="btn-group">
                                  <a  class="btn btn-primary" data-toggle="modal" data-target="#agencias">
                          ...
                          <form name="myform" method="POST" action="agencias_excel.php">
                    ...
                    $sql = "SELECT AG.SECUENCIAL,AG.NOMBRE, E.ESTADO FROM inventario_it.agencias AG INNER JOIN ESTADO E ON AG.SECUENCIALESTADO=E.SECUENCIAL ";
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      ?>
                                  ...
                                  <td><a class="btn btn-info"  href="modificar_agencia.php?id=<?= $row['SECUENCIAL'] ?>" >Editar</a></td>
                                  <?php
                                  if($row['ESTADO']=='ACTIVO'){
                                                                        
                                   ?>
                                  <td><a class="btn btn-danger" onclick="return confirm('Desea cambiar el estado del registro?')" href="eliminar_agencia.php?id=<?= $row['SECUENCIAL'] ?>">Inactivo</a></td>
                                   <?php  }else{
                                            
                                    ?> 
                                  <td><a class="btn btn-success" onclick="return confirm('Desea cambiar el estado del registro?')" href="eliminar_agencia.php?id=<?= $row['SECUENCIAL'] ?>">Activar</a></td>
...
<div class="modal fade" id="agencias" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Agregar Agencia</h5>
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Nombre:</label>
             <input type="text" name="nombre_agencia" class="form-control" style="text-transform:uppercase;" required>
          </div>
