...
$error=false;
 ...
 if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['btn-actualizar'])) {
    $secuencial_departamento=$_POST['id'];
     $nombre_departamento=strtoupper($_POST['nombre_departamento']);
    
    
    
            $sql="UPDATE inventario_it.departamento SET NOMBRE='$nombre_departamento' where SECUENCIAL='$secuencial_departamento'";
                if (mysqli_query($conn, $sql)) {
                
                //$error=true;
                //$confirmar_ingreso="El registro se guardo correctamente";
                //header('location:administracion.php');
                    echo "<script languaje='javascript'>alert('El departamento $nombre_departamento se actualizó correctamente');"
        ...
        <div class="col-md-12">
          ...
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Modificación Departamentos</h3>
            </div>
                          ...
                          <div class="clearfix">
                              <form role="form" method="post" class="row"> 
                                ...
                                $secuencial_departamento = $_GET['id'];
                                        ...
                                        $sql = "SELECT * FROM inventario_it.departamento where SECUENCIAL='$secuencial_departamento'";
                                        $query = $conn->query($sql);

                                            $row = $query->fetch_assoc();
                                            $secuencial_agencia2=$row['SECUENCIAL'];
                                             $nombre_agencia= $row['NOMBRE']; ?>
                                                    ...
                                                    <label>Id:</label>
                                                    <input type="text" name="id"   class="form-control" value="<?= $secuencial_agencia2?>" style="text-transform:uppercase;" required>
                                                 ...
                                                 <div class="form-group col-md-6" style="margin-bottom: 35px"  >
                                                    ...
                                                    <input type="text" name="nombre_departamento"  class="form-control" value="<?= $nombre_agencia?>" style="text-transform:uppercase;" required>
                                      ...
                                      <a id="btn-cancelar" class="btn btn-danger btn-lg " href="departamentos.php" name="btn-cancelar">Cancelar <i class="fa fa-times"></i></a>		
