...
$error=false;
 ...
 if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['btn-guardar'])) {
    $nombre_departamento=strtoupper($_POST['nombre_departamento']);
     
    
    
       
    
    $res=mysqli_query($conn,"SELECT * FROM inventario_it.departamento WHERE nombre='$nombre_departamento' ");
	   $row=mysqli_fetch_array($res);
	   $count = mysqli_num_rows($res); 
   
		if( $count != 0) {
			$error = true;
			$error_inventario = "El departamento $nombre_departamento ya se encuentra registrado";
                        
                  
		} else{
                    
                     
            $sql="INSERT INTO inventario_it.departamento (nombre) VALUES ('$nombre_departamento')";
            
                    
                if (mysqli_query($conn, $sql)) {
                
                //header('location:administracion.php');
                echo "<script languaje='javascript'>alert('El departamento $nombre_departamento se registro correctamente');"
        ...
        <ul>
          ...
          <li> <a href="javascript:void(0);"> <i class="fa fa-users icon"></i>Usuarios <span class="plus"><i class="fa fa-plus"></i></span> </a>
            ...
            <ul class="opened" style="display:block">
              ...
              <li> <a href="departamentos.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">Departamentos</b> </a> </li>
        ...
        <div class="col-md-12">
         ...
         <div class="porlets-content">
          ...
          <div class="adv-table table-responsive ">
                          ...
                          <div class="clearfix">
                              <div class="btn-group">
                                  <a  class="btn btn-primary" data-toggle="modal" data-target="#departamento">
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      ?>
                                  ...
                                  <td><a class="btn btn-info"  href="modificar_departamento.php?id=<?= $row['SECUENCIAL'] ?>" >Editar</a></td>
                                <td><a class="btn btn-danger" onclick="return confirm('Desea eliminar el registro?')" href="eliminar_departamento.php?id=<?= $row['SECUENCIAL'] ?>">Eliminar</a></td>
                                  </tr>
                                         <?php  }
...
<div class="modal fade" id="departamento" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Nombre:</label>
             <input type="text" name="nombre_departamento" class="form-control" style="text-transform:uppercase;" required>
          </div>
