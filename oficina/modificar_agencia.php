...
$error=false;
 ...
 if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['btn-actualizar'])) {
    $secuencial_agencia=$_POST['id'];
     $nombre_agencia=strtoupper($_POST['nombre']);
    
    
    
            $sql="UPDATE inventario_it.agencias SET NOMBRE='$nombre_agencia' where SECUENCIAL='$secuencial_agencia'";
                if (mysqli_query($conn, $sql)) {
                
                //$error=true;
                //$confirmar_ingreso="El registro se guardo correctamente";
                //header('location:administracion.php');
                    echo "<script languaje='javascript'>alert('La agencia $nombre_agencia se actualizó correctamente');"
        ...
        <div class="col-md-12">
          ...
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Modificación de agencias</h3>
            </div>
                          ...
                          <div class="clearfix">
                              <form role="form" method="post" class="row"> 
                                ...
                                $secuencial_agencia = $_GET['id'];
                                        ...
                                        $sql = "SELECT * FROM inventario_it.agencias where SECUENCIAL='$secuencial_agencia'";
                                            ...
                                            $secuencial_agencia2=$row['SECUENCIAL'];
                                             $nombre_agencia= $row['NOMBRE']; ?>
                                                 ...
                                                 <div class="form-group col-md-6" style="margin-bottom: 35px"  >
                                                    ...
                                                    <input type="text" name="nombre"  class="form-control" value="<?= $nombre_agencia?>" style="text-transform:uppercase;" required>
                                      ...
                                      <a id="btn-cancelar" class="btn btn-danger btn-lg " href="agencias.php" name="btn-cancelar">Cancelar <i class="fa fa-times"></i></a>		
