...
$error=false;
 ...
 if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['btn-actualizar'])) {
    $secuencial_marca=$_POST['id'];
     $nombre_marca=$_POST['nombre'];
    
    
    
            $sql="UPDATE inventario_it.marca SET NOMBRE='$nombre_marca' where SECUENCIAL='$secuencial_marca'";
                if (mysqli_query($conn, $sql)) {
                
                //$error=true;
                //$confirmar_ingreso="El registro se guardo correctamente";
                //header('location:administracion.php');
                    echo "<script languaje='javascript'>alert('La marca $nombre_marca se actualizo correctamente');"
        ...
        <div class="col-md-12">
          ...
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Modificación de marcas</h3>
            </div>
                          ...
                          <div class="clearfix">
                              <form role="form" method="post" class="row"> 
                                ...
                                $secuencial_marca = $_GET['id'];
                                        ...
                                        $sql = "SELECT * FROM inventario_it.marca where SECUENCIAL='$secuencial_marca'";
                                        $query = $conn->query($sql);

                                            $row = $query->fetch_assoc();
                                            $secuencial_marca2=$row['SECUENCIAL'];
                                             $nombre_marca= $row['NOMBRE']; ?>
                                                    ...
                                                    <label>Id:</label>
                                                    <input type="text" name="id"   class="form-control" value="<?= $secuencial_marca2?>" style="text-transform:uppercase;" required>
                                                 ...
                                                 <div class="form-group col-md-6" style="margin-bottom: 35px"  >
                                                    ...
                                                    <input type="text" name="nombre"  class="form-control" value="<?= $nombre_marca?>" style="text-transform:uppercase;" required>
                                      ...
                                      <a id="btn-cancelar" class="btn btn-danger btn-lg " href="marcas.php" name="btn-cancelar">Cancelar <i class="fa fa-times"></i></a>		
