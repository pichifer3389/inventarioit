...
$error=false;
 ...
 if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['btn-guardar'])) {
    ...
    $res=mysqli_query($conn,"SELECT * FROM marca WHERE nombre='$nombre_marca' ");
	   $row=mysqli_fetch_array($res);
	   $count = mysqli_num_rows($res); 
   
		if( $count != 0) {
			$error = true;
			$error_inventario = "La marca $nombre_marca ya se encuentra registrada";
                        
                  
		} else{
                    
                     
            $sql="INSERT INTO inventario_it.marca (nombre) VALUES ('$nombre_marca')";
            
                    
                if (mysqli_query($conn, $sql)) {
                
                //header('location:administracion.php');
                echo "<script languaje='javascript'>alert('La marca $nombre_marca se registro correctamente');"
        ...
        <ul>
          ...
          <li class="left_nav_active theme_border" > <a href="javascript:void(0);"> <i class="fa fa-edit"></i> Equipo<span class="plus"><i class="fa fa-plus"></i></span></a>
            <ul class="opened" style="display:block">
                <li> <a href="marcas.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">Marcas</b> </a> </li>
          ...
          <li> <a href="javascript:void(0);"> <i class="fa fa-users icon"></i>Usuarios <span class="plus"><i class="fa fa-plus"></i></span> </a>
            ...
            <ul>
              ...
              <li> <a href="../oficina/administrar_usuarios.php"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Puestos</b> </a> </li>
        ...
        <div class="col-md-12">
          ...
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Marcas equipos</h3>
            </div>
         <div class="porlets-content">
          ...
          <div class="adv-table table-responsive ">
                          ...
                          <div class="clearfix">
                              <div class="btn-group">
                                  <a  class="btn btn-primary" data-toggle="modal" data-target="#marcas">
                    ...
                    while($row = $query->fetch_assoc()){
                      ?>
                                  ...
                                  <td><a class="btn btn-info" onclick="return confirm('Desea modificar el registro?')" href="modificar_marca.php?id=<?= $row['SECUENCIAL'] ?>" >Editar</a></td>
                                  <td><a class="btn btn-danger" onclick="return confirm('Desea eliminar el registro?')" href="eliminar_marca.php?id=<?= $row['SECUENCIAL'] ?>">Eliminar</a></td>
                              </tr>
                                         <?php  }
