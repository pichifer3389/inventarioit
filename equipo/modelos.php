...
$error=false;
 ...
 if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['btn-guardar'])) {
    $nombre_modelo=strtoupper($_POST['nombre_modelo']);
    ...
    $res=mysqli_query($conn,"SELECT * FROM modelo WHERE nombre='$nombre_modelo' AND codigomarca='$codigo_marca' ");
	   $row=mysqli_fetch_array($res);
	   $count = mysqli_num_rows($res); 
   
		if( $count != 0) {
			$error = true;
			$error_inventario = "El modelo $nombre_modelo ya se encuentra registrado";
                        
                  
		} else{
                    
                     
            $sql="INSERT INTO inventario_it.modelo (nombre, codigomarca) VALUES ('$nombre_modelo','$codigo_marca')";
            
                    
                if (mysqli_query($conn, $sql)) {
                
                
                echo "<script languaje='javascript'>alert('El modelo $nombre_modelo se registro correctamente');"
        ...
        <ul>
          ...
          <li class="left_nav_active theme_border" > <a href="javascript:void(0);"> <i class="fa fa-edit"></i> Equipo<span class="plus"><i class="fa fa-plus"></i></span></a>
            <ul class="opened" style="display:block">
                ...
                <li> <a href="modelos.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">Modelo</b> </a> </li>
                <li> <a href="estado.php"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b >Estado</b> </a> </li>
                <li> <a href="prestamo.php"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b >Préstamos de equipo</b> </a> </li>
        ...
        <div class="col-md-12">
          ...
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Modelos equipos</h3>
            </div>
         <div class="porlets-content">
          ...
          <div class="adv-table table-responsive ">
                          ...
                          <div class="clearfix">
                              <div class="btn-group">
                                  <a  class="btn btn-primary" data-toggle="modal" data-target="#modelos">
                          ...
                          <form name="myform" method="POST" action="modelos_excel.php">
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      ?>
                                  ...
                                  <input name="nombre_modelo[]" hidden="hidden"  value="<?=$row['NOMBRE']?>">
                                  <input name="cod_marca[]" hidden="hidden"  value="<?=$row['CODIGOMARCA']?>">      
                                                                                                    
                                  <td><a class="btn btn-info" onclick="return confirm('Desea modificar el registro?')" href="modificar_modelo.php?id=<?= $row['SECUENCIAL'] ?>" >Editar</a></td>
                                  <td><a class="btn btn-danger" onclick="return confirm('Desea eliminar el registro?')" href="eliminar_modelo.php?id=<?= $row['SECUENCIAL'] ?>">Eliminar</a></td>
                              </tr>
                                         <?php  }
...
<div class="modal fade" id="modelos" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Agregar modelos de equipo</h5>
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Modelo:</label>
             <input type="text" name="nombre_modelo" class="form-control" style="text-transform:uppercase;" required>
          </div>
