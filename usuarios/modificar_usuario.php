...
$error=false;
 ...
 if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['btn-actualizar'])) {
    ...
    $rol=$_POST['rol'];
            ...
            $sql="UPDATE inventario_it.usuario SET USUARIO='$usuario', ROL='$rol' where SECUENCIAL='$secuencial_usuario'"
                    ;
                if (mysqli_query($conn, $sql)) {
                
                
                    echo "<script languaje='javascript'>alert('El usuario $usuario se actualizo correctamente');"
      ...
      <div class="pull-left breadcrumb_admin clear_both">
        ...
        <div class="pull-right">
          <ol class="breadcrumb">
              ...
              <li><a href="mantenimiento.php">Uusarios</a></li>
                          ...
                          <div class="clearfix">
                              <form role="form" method="post" class="row"> 
                                ...
                                $secuencial_usuario = $_GET['id'];
                                        ...
                                        $sql = "SELECT SECUENCIAL, USUARIO, ROL FROM inventario_it.usuario WHERE SECUENCIAL='$secuencial_usuario'";
                                        $query = $conn->query($sql);

                                            $row = $query->fetch_assoc();
                                            $codigousuario=$row['SECUENCIAL'];
                                            ...
                                            $rolempleado=$row['ROL'];
                                                    ...
                                                    <label>Id:</label>
                                                    <input type="text" name="id"   class="form-control" value="<?= $codigousuario?>" style="text-transform:uppercase;" required>
                                                 ...
                                                 <div class="form-group col-md-6" style="margin-bottom: 35px"  >
                                                    <label>Usuario:</label>
                                                    <input type="text" name="usuario"  class="form-control" value="<?= $nombreusuario?>" style="text-transform:uppercase;" required>
                                      ...
                                      <a id="btn-cancelar" class="btn btn-danger btn-lg " href="mantenimiento.php" name="btn-cancelar">Cancelar <i class="fa fa-times"></i></a>		
