...
$error=false;
 ...
 if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['btn-guardar'])) {
    ...
    $res=mysqli_query($conn,"SELECT * FROM inventario_it.usuario WHERE USUARIO='$usuario' or CODIGOEMPLEADO='$codigoempleado'");
	   $row=mysqli_fetch_array($res);
	   $count = mysqli_num_rows($res); 
   
		if( $count != 0) {
			$error = true;
			$error_inventario = "Este usuario/empleado ya se encuentra registrado";
                 
		} else{
                    
            $password = hash('sha256', $pass);
            $sql="INSERT INTO inventario_it.usuario (usuario, password,rol,codigoempleado,codigoestado) VALUES ('$usuario','$password','$rol','$codigoempleado','$codigoestado')";  
			...
			$(document).ready(function(){
				$("#oficina").change(function () {
					...
					$("#oficina option:selected").each(function () {
						SECUENCIAL = $(this).val();
						$.post("../usuarios/obtenerEmpleado.php", { SECUENCIAL: SECUENCIAL }, function(data){
							$("#empleados").html(data);
						});            
					});
				});
    ...
    <!--\\\\\\\ inner start \\\\\\--><div class="left_nav">
      ...
      <div class="left_nav_slidebar">
        ...
        <ul>
          ...
          <li class="left_nav_active theme_border"> <a href="javascript:void(0);"> <i class="fa fa-users icon"></i>Usuarios<span class="plus"><i class="fa fa-plus"></i></span> </a>
            <ul class="opened" style="display:block">
                
              <li> <a href="mantenimiento.php"> <span>&nbsp;</span> <i class="fa fa-circle "></i> <b class="theme_color">Mantenimiento</b> </a> </li>
      ...
      <div class="pull-left breadcrumb_admin clear_both">
        ...
        <div class="pull-right">
          <ol class="breadcrumb">
              ...
              <li><a href="mantenimiento.php">Usuarios</a></li>
        ...
        <div class="col-md-12">
         ...
         <div class="porlets-content">
          ...
          <div class="adv-table table-responsive ">
                          ...
                          <div class="clearfix">
                              <div class="btn-group">
                                  <a  class="btn btn-primary" data-toggle="modal" data-target="#usuarios">
                          ...
                          <form name="myform" method="POST" action="usuarios_excel.php">
                    ...
                    $sql = "SELECT 
                                ...
                                USU.SECUENCIAL,
                                ES.ESTADO  
                                FROM inventario_it.usuario usu
                                INNER JOIN EMPLEADO E ON USU.CODIGOEMPLEADO=E.SECUENCIAL
                                INNER JOIN PUESTO P ON E.CODIGOPUESTO=P.SECUENCIAL
                                INNER JOIN ESTADO ES ON ES.SECUENCIAL=USU.CODIGOESTADO ";
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      ?>
                                  ...
                                  <td><?= $row['ESTADO'];?></td>
                                    ...
                                    <input name="usuario[]" hidden="hidden"  value="<?=$row['USUARIO']?>">  
                                    <input name="nombre_empleado[]" hidden="hidden"  value="<?=$row['NOMBRE']?>">  
                                    <input name="rol[]" hidden="hidden"  value="<?=$row['ROL']?>">
                                  ...
                                  <td><a class="btn btn-info"  href="modificar_usuario.php?id=<?= $row['SECUENCIAL'] ?>" >Editar</a></td>
                                  
                                  <?php  }else{
                                            
                                    ?> 
                                  <td><a class="btn btn-primary" title="El usario y/o empleado se encuentra inactivo! " readonly="readonly" ?>Editar</a></td>
                                  <?php }
                                ...
                                <?php
                                  if($row['ESTADO']=='ACTIVO'){
                                   ...
                                   ?>
                                  <td><a class="btn btn-danger" onclick="return confirm('Desea cambiar el estado del registro?')" href="eliminar_usuario.php?id=<?= $row['SECUENCIAL'] ?>">Inactivo</a></td>
                                   <?php  }else{
                                            
                                    ?> 
                                  <td><a class="btn btn-success" onclick="return confirm('Desea cambiar el estado del registro?')" href="eliminar_usuario.php?id=<?= $row['SECUENCIAL'] ?>">Activar</a></td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form method="post" action="" id="Q_A">
            ...
            <select id="oficina" name="codigo_oficina" class="form-control" required>
            ...
            <select id="empleados" name="codigo_empleado" class="form-control" required>
                            </select>
